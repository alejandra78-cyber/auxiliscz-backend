-- Ajuste histórico de timestamps guardados en UTC-naive hacia hora local Bolivia (UTC-4).
-- Ejecutar SOLO si confirmaste que los datos históricos están en UTC.
